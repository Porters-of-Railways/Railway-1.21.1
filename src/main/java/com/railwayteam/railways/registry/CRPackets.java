...
public class CRPackets {
    ...
    .c2s(StationLimitPacket.class, StationLimitPacket::new)
        ...
        .s2c(InitializeTrainCarriagesPacket.class, InitializeTrainCarriagesPacket::new)
        .s2c(ChopTrainEndPacket.class, ChopTrainEndPacket::new)
        .s2c(SplitTrainEndPacket.class, SplitTrainEndPacket::new)
        ...
        .s2c(FullTrainSyncPacket.class, FullTrainSyncPacket::new)
